...
public class DetalleSolicitudLecturaConfiguration : IEntityTypeConfiguration<DetalleSolicitudLectura>
{
    public void Configure(EntityTypeBuilder<DetalleSolicitudLectura> builder)
    {
        ...
        builder.Property(d => d.LecturaAnterior)
    .HasColumnName("Lec_ant_detalle")
    .HasPrecision(18, 2);

        builder.Property(d => d.LecturaActual)
            .HasColumnName("Lec_act_detalle")
            .HasPrecision(18, 2);

        builder.Property(d => d.Consumo)
            .HasColumnName("Consumo_detalle")
            .HasPrecision(18, 2);
