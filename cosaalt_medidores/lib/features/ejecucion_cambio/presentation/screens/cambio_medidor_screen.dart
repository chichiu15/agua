                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (parsed == null || parsed < 0) return 'Ingrese una lectura válida';
                          return null;
                        },
                      ),
                      const SizedBox(height: 10),
                      ...
                      TextFormField(
                        ...
                        decoration: const InputDecoration(labelText: 'Nro. Medidor Instalado *'),
                      ...
                      DropdownButtonFormField<String>(
                        value: _estadoNuevo,
                        decoration: const InputDecoration(labelText: 'Estado del medidor *'),
                        items: const [
                          DropdownMenuItem(value: 'Nuevo', child: Text('Nuevo')),
                          DropdownMenuItem(value: 'Medio uso', child: Text('Medio uso')),
                        ],
                        onChanged: (value) => setState(() => _estadoNuevo = value ?? 'Nuevo'),
                      ),
                      const SizedBox(height: 10),
                      TextFormField(
